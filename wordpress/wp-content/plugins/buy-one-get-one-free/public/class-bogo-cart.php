...
class Pi_Bogo_Cart{
    ...
    public static function init(){
        ...
        if($global_disable != 1){
            ...
            add_filter( 'woocommerce_cart_item_quantity', array( __CLASS__, 'removeQuantityEdit' ), 10, 2 );

            /**
             * there are 2 different filters for simple product and variable product price
             */
            add_filter('woocommerce_product_get_price', array( __CLASS__, 'modifyGetPriceConflictFixer' ), PHP_INT_MAX, 2 );
            add_filter('woocommerce_product_variation_get_price', array( __CLASS__, 'modifyGetPriceConflictFixer' ), PHP_INT_MAX, 2 );
        }
    }
    ...
    public static function removeQuantityEdit( $product_quantity, $cart_item_key ) {
