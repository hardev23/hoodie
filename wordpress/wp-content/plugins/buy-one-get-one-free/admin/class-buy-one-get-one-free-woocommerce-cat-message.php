...
class Buy_One_Get_One_Free_Woocommerce_Cat_Message{
    ...
    function tab(){
        $this->tab_name = __('Category Message (PRO)', 'buy-one-get-one-free-woocommerce');
        ?>
    ...
    function tab_content(){
       ?>
        ...
        ?>
        <input type="submit" class="mt-3 btn btn-primary btn-sm" value="<?php _e('Save Option','buy-one-get-one-free-woocommerce'); ?>" />
        </form>
       <?php
    }
