...
v1.0.1
*/
if(!class_exists('pisol_bogo_deal_maker_review')){
class pisol_bogo_deal_maker_review{
...
new pisol_bogo_deal_maker_review('Buy X get Y free deal maker plugin', 'buy-one-get-one-free');
}